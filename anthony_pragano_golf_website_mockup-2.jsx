        ...
        <div className="relative max-w-[90rem] mx-auto px-6 py-20 lg:py-32 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button className="bg-gradient-to-r from-[#ff7a00] via-[#ffb347] to-[#ff7a00] hover:scale-[1.03] border-[3px] border-[#ffb067] text-black font-black italic uppercase skew-x-[-6deg] px-8 py-4 rounded-none clip-path-slant transition-all duration-150 shadow-[0_0_10px_rgba(255,140,26,0.15)] uppercase tracking-[0.2em]">
                Book Coaching
              </button>

              <button className="bg-gradient-to-r from-[#ff7a00] via-[#ffb347] to-[#ff7a00] hover:scale-[1.03] border-[3px] border-[#ffb067] text-black font-black italic uppercase skew-x-[-6deg] px-8 py-4 rounded-none clip-path-slant transition-all duration-150 shadow-[0_0_10px_rgba(255,140,26,0.15)] tracking-[0.2em]">
                View Programs
              </button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div className="border border-[#ff8c1a]/30 bg-[linear-gradient(to_bottom_right,#050505,#000,#140800)] p-8 rounded-none clip-path-slant">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { name: 'PUMA GOLF', logo: '/mnt/data/PUMA-Golf-BU-logo-black_623eb9ea-be7e-4e47-905e-c73a5d82fc70(1).avif' },
                    { name: 'COBRA GOLF', logo: '/mnt/data/b5da7f914e1707f16bd11a386ce3c4ad.w1724.h628(1).png' }
                  ].map((brand) => (
                    <div
                      key={brand.name}
              ...
              <div className="border border-[#ff8c1a]/30 bg-[linear-gradient(to_bottom_right,#050505,#000,#140800)] p-8 rounded-none clip-path-slant">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    { name: 'COBRA', logo: '/mnt/data/b5da7f914e1707f16bd11a386ce3c4ad.w1724.h628(1).png' },
                    { name: 'TITLEIST', logo: '/mnt/data/Titleist_golf_logo.png' }
                  ].map((brand) => (
                    <div
                      key={brand.name}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <div className="text-5xl font-black italic uppercase skew-x-[-6deg] tracking-[-0.08em] mb-8">{program.price}</div>
